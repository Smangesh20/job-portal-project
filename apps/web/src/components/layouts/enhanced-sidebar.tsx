...
// ENHANCED PROFESSIONAL SIDEBAR - ALL OPTIONS MOVED HERE
export function EnhancedSidebar() {
  ...
  return (
    <>
      ...
      {/* Enhanced Sidebar */}
      <div className={cn(
        "fixed inset-y-0 left-0 z-40 w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transform transition-transform duration-300 ease-in-out overflow-y-auto",
