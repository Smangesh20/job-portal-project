...
import { getBulletproofWelcomeMessage, setBulletproofUserName } from '@/utils/bulletproof-welcome'
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'
import { Button } from '@/components/ui/button'
import { Input } from '@/components/ui/input'
import { useAuthUnified } from '@/hooks/useAuthUnified'

export function BulletproofTest() {
  ...
  const handleSetName = () => {
    if (testName.trim()) {
      setBulletproofUserName(testName.trim())
  ...
  return (
    <div className="space-y-6">
      <Card className="border-2 border-green-200 bg-green-50/50">
        <CardHeader>
          <CardTitle className="text-green-800">🔧 BULLETPROOF DROPDOWN TEST</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="p-4 bg-white rounded-lg border">
            ...
            <p className="text-sm text-gray-600 mb-3">
              Current welcome message: <strong>{getBulletproofWelcomeMessage(user)}</strong>
            </p>
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <h3 className="text-lg font-semibold text-blue-800 mb-2">🔧 BULLETPROOF INSTRUCTIONS</h3>
