  ...
  const [companies, setCompanies] = useState([
    {
      ...
      rating: 4.8,
      jobs: 1250,
      description: 'Leading technology company focused on AI, cloud computing, and innovation.',
    ...
    },
    {
      ...
      rating: 4.7,
      jobs: 980,
      description: 'Global technology leader in cloud services, productivity software, and AI.',
    ...
    },
    {
      ...
      rating: 4.4,
      jobs: 890,
      description: 'Sustainable energy and electric vehicle company driving the future of transportation.',
      benefits: ['Health Insurance', '401k', 'Stock Options', 'EV Discounts'],
      isTop: true,
      isFortune500: true
    },
    {
      ...
      rating: 4.3,
      jobs: 650,
      description: 'Building the metaverse and connecting people through social platforms.',
      benefits: ['Health Insurance', '401k', 'Stock Options', 'VR Equipment'],
      isTop: true,
      isFortune500: true
    }
  ])
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Discover the most prestigious and innovative companies in the industry
          </p>
        </div>
