...
export default function HomePage() {
  ...
  const handleGoogleSignIn = () => {
    // 🚀 GOOGLE AUTHENTICATION FLOW - WORKS LIKE GOOGLE
    const googleAuthUrl = 'https://accounts.google.com/signin/v2/identifier?flowName=GlifWebSignIn&flowEntry=ServiceLogin&continue=' + encodeURIComponent(window.location.origin + '/dashboard')
