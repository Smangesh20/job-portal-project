...
export async function GET(request: NextRequest) {
  try {
    ...
    // 🚀 GOOGLE CLIENT ID - ENTERPRISE LEVEL
    const clientId = process.env.GOOGLE_CLIENT_ID || '1082042683309-meo1kq8oupj1jkg0bj2e06aecg6nn6gn.apps.googleusercontent.com'
