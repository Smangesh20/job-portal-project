...
export async function GET(request: NextRequest) {
  try {
    ...
    if (error) {
      ...
      return NextResponse.redirect('https://www.askyacham.com/signup?error=google_auth_failed')
    }

    if (!code) {
      return NextResponse.redirect('https://www.askyacham.com/signup?error=no_code')
    }
    ...
    if (!tokenResponse.ok) {
      ...
      return NextResponse.redirect('https://www.askyacham.com/signup?error=token_exchange_failed')
    }
    ...
    if (!userResponse.ok) {
      ...
      return NextResponse.redirect('https://www.askyacham.com/signup?error=user_info_failed')
    }
    ...
    return NextResponse.redirect('https://www.askyacham.com/signup?error=google_callback_failed')
  }
}
