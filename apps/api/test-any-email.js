...
/**
 * TEST ANY EMAIL ADDRESS - Google-like Implementation
 * This script tests email delivery to any email address you specify
 */

require('dotenv').config();

async function testAnyEmail() {
  console.log('🚀 TEST ANY EMAIL ADDRESS - Google-like Implementation\n');
  
  // Get email from command line argument or use default
  const testEmail = process.argv[2] || 'test@example.com';
  
  console.log(`📧 Testing email delivery to: ${testEmail}`);
  console.log('💡 Usage: node test-any-email.js your-email@domain.com\n');
